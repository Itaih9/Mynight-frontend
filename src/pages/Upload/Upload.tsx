             ...
             <div className="space-y-2">
                <div className="flex items-center gap-3">
                   <div className="relative">
                      ...
                      {!hasSlug && <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-red-500 rounded-full ring-2 ring-gray-100 animate-pulse" />}
                   </div>
                ...
                <div className="flex items-center gap-3">
                   <div className="relative">
                      ...
                      {!hasFile && <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-red-500 rounded-full ring-2 ring-gray-100 animate-pulse" />}
                   </div>
